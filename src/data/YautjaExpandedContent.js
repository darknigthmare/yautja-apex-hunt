...
export const EXPANDED_TECH_CATALOG = [
  ...
  { id: 'tech_feral_bolt_launcher', name: 'Lance-traits du Feral', sourceTier: 'SCREEN', description: 'Arme de traits guidés utilisée par le chasseur de Prey.', sources: ['prey2022'], gameplay: 'Rencontre 3D réelle : le boss Feral tire une salve mobile de trois traits.', runtimeStatus: 'encounter' },
