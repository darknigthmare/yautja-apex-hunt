...
export const EXPANDED_TECH_CATALOG = [
  ...
  { id: 'tech_wolf_dual_plasma', name: 'Double canon à plasma de Wolf', sourceTier: 'AVP_SCREEN', description: 'Wolf emploie deux canons d’épaule durant l’incident de Gunnison.', sources: ['avpRequiem2007'], gameplay: 'Rencontre 3D réelle : deux projectiles indépendants tirés en salve.', runtimeStatus: 'encounter' },
