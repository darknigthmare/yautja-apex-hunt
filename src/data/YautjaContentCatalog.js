...
export const ENEMY_CATALOG = freezeCatalog([
  { id: 'enemy_elite_commando', name: 'Commando d’élite', sourceTier: 'SCREEN', description: 'Soldat entraîné comparable aux membres de l’équipe traquée dans Predator.', sources: ['predator1987'], role: 'Escouade coordonnée utilisant couverture, explosifs et tir de suppression.' },
  ...
  { id: 'enemy_wartime_pilot', name: 'Pilote de guerre', sourceTier: 'SCREEN', description: 'Combattant aérien inspiré du segment du XXe siècle de Killer of Killers.', sources: ['killerOfKillers'], role: 'Menace mobile qui mitraille les zones ouvertes depuis les airs.' },
