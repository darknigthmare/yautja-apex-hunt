...
export const LEVEL_EVENT_CATALOG = freezeCatalog([
  ...
  { id: 'event_pyramid_shift', name: 'Reconfiguration de la pyramide', sourceTier: 'AVP_SCREEN', description: 'Adaptation de gameplay originale des couloirs mobiles de la pyramide AVP.', sources: ['avp2004'], gameplay: 'Événement localisé : les murs ferment une route, ouvrent une chambre et imposent un nouvel itinéraire avant la prochaine phase.', implementationOriginal: true, runtimeStatus: 'encounter' },
