...
| `ryushi-frontier-panels` | `public/assets/textures/ryushi-frontier-panels.webp` | 1254×1254 | 400 470 octets | homestead, château d’eau, enclos, épaves et structures humaines | présent et référencé par le catalogue de props v1.6 |
...
Les quatre WebP 1254×1254 de cette passe totalisent 1 669 128 octets :

- `ryushi-frontier-panels.webp` — 400 470 octets ;
- `hive-biomechanical-membrane.webp` — 339 384 octets ;
...
- PNG maîtres locaux, lorsqu’ils sont conservés comme sources de travail, exclus du versionnement et du déploiement ;
